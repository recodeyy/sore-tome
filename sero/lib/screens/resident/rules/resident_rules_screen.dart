...
class ResidentRulesScreen extends ConsumerStatefulWidget {
  const ResidentRulesScreen({super.key});

  @override
  ConsumerState<ResidentRulesScreen> createState() => _ResidentRulesScreenState();
}

class _ResidentRulesScreenState extends ConsumerState<ResidentRulesScreen> {

...
class _ChannelChatScreenState extends ConsumerState<ChannelChatScreen> {
  ...
  Future<void> _markAsRead() async {
    try {
      // CUTOVER: canonical /channels-v2 read receipt. Strict schema accepts an
      // optional { lastReadMessageId }; an empty body marks the channel read.
      await ApiService.post('/channels-v2/${widget.channel.id}/read', {});
    } catch (_) {}
  }

  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return userAsync.when(
      data: (user) {
        ...
        // Society scoping gate: if the active token is unscoped (the user has
        // >1 workspace and hasn't selected one), never load a society-scoped
        // data screen — it would silently render zeros/blanks. Send them to the
        // workspace selector instead.
        if (ref.read(authProvider.notifier).requiresWorkspaceSelection) {

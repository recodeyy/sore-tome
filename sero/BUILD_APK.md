...
flutter clean
flutter pub get
flutter build apk --release --dart-define=API_BASE_URL=https://sero-api-m477e5mida-el.a.run.app/api/v1
# output: build/app/outputs/flutter-apk/app-release.apk
```

> **Production backend = GCP Cloud Run** `sero-api` in project `mediflow-nexus-2026`
> (region `asia-south1`): `https://sero-api-m477e5mida-el.a.run.app/api/v1`.
> The old `sero-api.onrender.com` URL is **DEAD** — the Render free-tier subdomain
> was reclaimed and now serves an unrelated app. Do not use it. See
> `RECOVERY_GCP_DEPLOYMENT_AUDIT.md`.

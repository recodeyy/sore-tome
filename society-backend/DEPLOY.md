...
> ⚠️ **ACTUAL PRODUCTION (2026-06-25): GCP Cloud Run, not Render.** The live
> backend is the `sero-api` Cloud Run service in project `mediflow-nexus-2026`
> (region `asia-south1`). The Render URLs below are **dead** — the free-tier
> `sero-api.onrender.com` subdomain was reclaimed and now serves a different
> app. See `../RECOVERY_GCP_DEPLOYMENT_AUDIT.md`.
>
> - Public URL: **`https://sero-api-m477e5mida-el.a.run.app`**
> - API base for the app: **`https://sero-api-m477e5mida-el.a.run.app/api/v1`**
> - Health: `https://sero-api-m477e5mida-el.a.run.app/health`
> - Redeploy: `gcloud run deploy sero-api --source . --region asia-south1 --project mediflow-nexus-2026`
> - Rollback: `gcloud run services update-traffic sero-api --to-revisions sero-api-00001-djz=100 --region asia-south1 --project mediflow-nexus-2026`

### (Legacy / dead) Render URLs — do not use

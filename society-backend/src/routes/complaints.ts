...
router.get("/analytics", authMiddleware, requireSociety, tenantMiddleware, canManageContent, async (req: Request, res: Response) => {
  try {
...
router.post("/", authMiddleware, requireSociety, tenantMiddleware, validate(CreateComplaintSchema), async (req: Request, res: Response) => {
  try {
...
router.post("/:id/assign", authMiddleware, requireSociety, tenantMiddleware, canManageContent, validate(AssignComplaintSchema), async (req: Request, res: Response) => {
  try {
...
router.patch("/:id/status", authMiddleware, requireSociety, tenantMiddleware, canManageContent, validate(ComplaintStatusSchema), async (req: Request, res: Response) => {
  try {
...
router.post("/:id/sla-pause", authMiddleware, requireSociety, tenantMiddleware, canManageContent, validate(ComplaintSlaPauseSchema), async (req: Request, res: Response) => {
  try {
...
router.post("/:id/comments", authMiddleware, requireSociety, tenantMiddleware, validate(ComplaintCommentSchema), async (req: Request, res: Response) => {
  try {
...
router.post("/:id/feedback", authMiddleware, requireSociety, tenantMiddleware, validate(ComplaintFeedbackSchema), async (req: Request, res: Response) => {
  try {
...
router.get("/:id/attachments", authMiddleware, requireSociety, tenantMiddleware, async (req: Request, res: Response) => {
  try {
    if (!isAdminRole(req)) {
...
router.post("/:id/attachments", authMiddleware, requireSociety, tenantMiddleware, async (req: Request, res: Response) => {
  try {
...
router.post("/run-escalations", authMiddleware, requireSociety, tenantMiddleware, canManageContent, async (req: Request, res: Response) => {
  try {

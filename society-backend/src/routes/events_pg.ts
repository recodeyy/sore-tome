...
router.post("/", authMiddleware, requireSociety, tenantMiddleware, canManageContent, validate(CreateEventSchema), async (req: Request, res: Response) => {
  try {
...
router.post("/:id/cancel", authMiddleware, requireSociety, tenantMiddleware, canManageContent, async (req: Request, res: Response) => {
  try {
...
router.post("/:id/rsvp", authMiddleware, requireSociety, tenantMiddleware, validate(RsvpSchema), async (req: Request, res: Response) => {
  try {
...
router.post("/:id/rsvp/cancel", authMiddleware, requireSociety, tenantMiddleware, async (req: Request, res: Response) => {
  try {
...
router.post("/:id/attendance", authMiddleware, requireSociety, tenantMiddleware, canManageContent, validate(AttendanceSchema), async (req: Request, res: Response) => {
  try {

 ...
 */
router.get("/dashboard-stats", authMiddleware, adminOnly, requireSociety, tenantMiddleware, async (req: Request, res: Response) => {
  try {
 ...
 */
router.get("/dashboard/summary", authMiddleware, adminOnly, requireSociety, tenantMiddleware, async (req: Request, res: Response) => {
  try {
 ...
 */
router.get("/dashboard/vitals", authMiddleware, adminOnly, requireSociety, tenantMiddleware, async (req: Request, res: Response) => {
  try {
 ...
 */
router.get("/dashboard/trends", authMiddleware, adminOnly, requireSociety, tenantMiddleware, async (req: Request, res: Response) => {
  try {
 ...
 */
router.get("/dashboard/alerts", authMiddleware, adminOnly, requireSociety, tenantMiddleware, async (req: Request, res: Response) => {
  try {
 ...
 */
router.get("/dashboard/activity", authMiddleware, adminOnly, requireSociety, tenantMiddleware, async (req: Request, res: Response) => {
  try {
 ...
 */
router.get("/search", authMiddleware, adminOnly, requireSociety, tenantMiddleware, async (req: Request, res: Response) => {
  try {
    const limit = req.query.limit ? Number(req.query.limit) : 20;
 ...
 */
router.get("/dashboard/preferences", authMiddleware, adminOnly, requireSociety, tenantMiddleware, async (req: Request, res: Response) => {
  try {
 ...
 */
router.put("/dashboard/preferences", authMiddleware, adminOnly, requireSociety, tenantMiddleware, async (req: Request, res: Response) => {
  try {
